...
with facebook_platform_device_click as
(
  select  * FROM {{ source('ft_facebook_ad', 'platform_device_click') }}
) ,

facebook_platform_device_click_actions as
(
  select  * from {{ source('ft_facebook_ad', 'platform_device_click_actions') }}  
) ,


facebook_platform_device_click_video_p_100 as
(
  select  * from {{ source('ft_facebook_ad', 'platform_device_click_video_p_100_watched_actions') }}  
) ,
facebook_platform_device_click_video_p_95 as
(
  select  * from {{ source('ft_facebook_ad', 'platform_device_click_video_p_95_watched_actions') }}  
) ,
facebook_platform_device_click_video_p_75 as
(
  select  * from {{ source('ft_facebook_ad', 'platform_device_click_video_p_75_watched_actions') }}  
) ,
facebook_platform_device_click_video_p_50 as
(
  select  * from {{ source('ft_facebook_ad', 'platform_device_click_video_p_50_watched_actions') }}  
) ,
facebook_platform_device_click_video_p_25 as
(
  select  * from {{ source('ft_facebook_ad', 'platform_device_click_video_p_25_watched_actions') }}  
) ,
...
(
  SELECT * 
      FROM(
        ...
        from facebook_platform_device_click_actions ra 
        where true
...
FROM facebook_platform_device_click
 left join  fb_actions_pivot as  ra using (ad_id, date,_fivetran_id) 
 left join facebook_platform_device_click_video_p_100 v100 using(ad_id, date,_fivetran_id)
 left join facebook_platform_device_click_video_p_95 v95 using(ad_id, date,_fivetran_id)
 left join facebook_platform_device_click_video_p_75 v75 using(ad_id, date,_fivetran_id)
 left join facebook_platform_device_click_video_p_50 v50 using(ad_id, date,_fivetran_id)
 left join facebook_platform_device_click_video_p_25 v25 using(ad_id, date,_fivetran_id)
