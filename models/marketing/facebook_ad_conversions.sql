...
facebook_basic_report_video_p_100 as
(
  select * from {{ source('ft_facebook_ad', 'basic_report_video_p_100_watched_actions') }}  
) ,
facebook_basic_report_video_p_95 as
(
  select * from {{ source('ft_facebook_ad', 'basic_report_video_p_100_watched_actions') }}  
) ,
facebook_basic_report_video_p_75 as
(
  select * from {{ source('ft_facebook_ad', 'basic_report_video_p_75_watched_actions') }}  
) ,
facebook_basic_report_video_p_50 as
(
  select * from {{ source('ft_facebook_ad', 'basic_report_video_p_50_watched_actions') }}  
) ,
facebook_basic_report_video_p_25 as
(
  select * from {{ source('ft_facebook_ad', 'basic_report_video_p_25_watched_actions') }}  
) ,
...
adset_id,
ad_id,
"www.stage-entertainment.de" traffic,
...
FROM facebook_ad_basic
 left join  fb_actions_pivot as  ra using (_fivetran_id,ad_id, date ) 
 left join facebook_basic_report_video_p_100 v100 using(_fivetran_id,ad_id, date ) 
 left join facebook_basic_report_video_p_95 v95 using(_fivetran_id,ad_id, date ) 
 left join facebook_basic_report_video_p_75 v75 using(_fivetran_id,ad_id, date ) 
 left join facebook_basic_report_video_p_50 v50 using(_fivetran_id,ad_id, date ) 
 left join facebook_basic_report_video_p_25 v25 using(_fivetran_id,ad_id, date ) 
